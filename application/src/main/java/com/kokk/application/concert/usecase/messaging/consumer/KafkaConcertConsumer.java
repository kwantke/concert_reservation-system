package com.kokk.application.concert.usecase.messaging.consumer;
...
public class KafkaConcertConsumer {
  ...
  @KafkaListener(groupId ="outbox-group" ,topics = "${spring.kafka.topic.reserve}")
  public void consumeOutbox(ConsumerRecord<String, String> event, Acknowledgment ack) throws JsonProcessingException {
    Outbox outbox = objectMapper.readValue(event.value(), Outbox.class);
    outboxServicePort.publish(outbox.getEventKey());
